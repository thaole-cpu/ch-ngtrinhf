...
def load_data():
    with open('D:\chinhsua\\ty\data1.json', 'r', encoding='utf-8') as f:
        career_data = json.load(f)
    with open('D:\chinhsua\\ty\data2.json', 'r', encoding='utf-8') as f:
...
def filter_school_by_tuition(school_data, max_tuition):
    ...
    for school in school_data:
        ...
        if min_tuition <= max_tuition <= max_tuition_in_data:
...
def save_user_data1(user_data):
    try:
        with open("D:\chinhsua\\ty\\test_results.json", "r", encoding="utf-8") as f:
    ...
    with open("D:\chinhsua\\ty\\test_results.json", "w", encoding="utf-8") as f:
